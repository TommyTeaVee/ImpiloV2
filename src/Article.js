      ...
      <div className="uk-grid-small uk-grid-divider" data-uk-grid="">
        <div className="uk-width-1-2@s">
          ...
          <div className="uk-flex uk-flex-column uk-flex-right">
            <img src={language.src} alt={language.alt} className={language.className} />
        ...
        <div className="uk-width-2-2@s">
          ...
          >
            <div>
              <p className="uk-dropcap">{language["bio"]}</p>
            </div>
            <div>
              <strong>Motto:</strong><p className="uk-dropcap">{language["other_text_1"]}</p>
            </div>
          </div>
          <hr />
