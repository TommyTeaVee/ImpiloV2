...
export default [
	{  
		locale: "en",
		name: "English",
		fontFamily: "'Didot', cursive",
		title: "IMPILO Digital Magazine",
		head_line: "Welcome note ",
		translate_by: "(written by Tommy)",
		whats_it:
			"I create this small website to share how to write code for website. Go to view source code to see all the code. Then begin learning how to create one like this website by viewing the code or copy to create on your own from this template. Hope you will learn something or inspire you to create or apply to your own website.",
		other_text_1:
		...
		made_by: "TommyTV",
		type: 'image',
			src: 'https://via.placeholder.com/320x240?text=Image+1',
			alt: 'Sthembele Mathebula posing',
